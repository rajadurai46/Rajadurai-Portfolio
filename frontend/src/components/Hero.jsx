        ...
        <div className="grid gap-10 lg:grid-cols-2 items-center text-center lg:text-left">
          ...
          >
            ...
            <Link to="contact" smooth duration={500}>
              <motion.button
                whileHover={{ scale: 1.1 }} // hover allowed
                ...
                transition-all dark:hover:bg-cyan-400
                "
              >
                Hire Me
              </motion.button>
          ...
          >
            ...
            {/* Typed Role (loop is intentional) */}
            <div className="flex justify-center lg:justify-start mt-4 text-2xl sm:text-3xl">
